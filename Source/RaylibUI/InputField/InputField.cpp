...
int main()
{
    ...
    InitWindow(WIDTH, HEIGHT, "Proper input field UI element");
    SetTargetFPS(60);

    //variable initialisation
    InputField filename_inpt(300, 50, 2, "file.txt...", 20);
    ...
    while (!WindowShouldClose()) 
    {
        ...
        filename_inpt.Draw(100, 100);
        
        if (filename_inpt.IsSelected() && IsKeyPressed(KEY_ENTER))
        {
            std::cout << filename_inpt.GetText() << std::endl;
            filename_inpt.Clear();
        }
